...
//
// The C++ twin of br_arb_grant_hold_tb.prp: same cycle count, same reset schedule, same
...
#include "Vbr_arb_grant_hold_harness.h"
#include "verilated.h"
...
int main(int argc, char **argv) {
  ...
  auto *top = new Vbr_arb_grant_hold_harness;
