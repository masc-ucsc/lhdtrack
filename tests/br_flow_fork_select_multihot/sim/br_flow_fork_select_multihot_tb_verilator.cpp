...
//
// The C++ twin of br_flow_fork_select_multihot_tb.prp: same cycle count, same reset schedule, same
...
#include "Vbr_flow_fork_select_multihot_harness.h"
#include "verilated.h"
...
int main(int argc, char **argv) {
  ...
  auto *top = new Vbr_flow_fork_select_multihot_harness;
