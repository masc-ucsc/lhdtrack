...
//
// The C++ twin of br_tracker_linked_list_ctrl_tb.prp: same cycle count, same reset schedule, same
...
#include "Vbr_tracker_linked_list_ctrl_harness.h"
#include "verilated.h"
...
int main(int argc, char **argv) {
  ...
  auto *top = new Vbr_tracker_linked_list_ctrl_harness;
