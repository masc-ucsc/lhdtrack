...
//
// The C++ twin of br_tracker_sequence_tb.prp: same cycle count, same reset schedule, same
...
#include "Vbr_tracker_sequence_harness.h"
#include "verilated.h"
...
int main(int argc, char **argv) {
  ...
  auto *top = new Vbr_tracker_sequence_harness;
