...
//
// The C++ twin of br_credit_sender_vc_tb.prp: same cycle count, same reset schedule, same
...
#include "Vbr_credit_sender_vc_harness.h"
#include "verilated.h"
...
int main(int argc, char **argv) {
  ...
  auto *top = new Vbr_credit_sender_vc_harness;
