...
//
// The C++ twin of br_misc_tieoff_one_tb.prp: same cycle count, same reset schedule, same
...
#include "Vbr_misc_tieoff_one_harness.h"
#include "verilated.h"
...
int main(int argc, char **argv) {
  ...
  auto *top = new Vbr_misc_tieoff_one_harness;
