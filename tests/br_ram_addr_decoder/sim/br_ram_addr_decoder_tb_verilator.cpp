...
//
// The C++ twin of br_ram_addr_decoder_tb.prp: same cycle count, same reset schedule, same
...
#include "Vbr_ram_addr_decoder_harness.h"
#include "verilated.h"
...
int main(int argc, char **argv) {
  ...
  auto *top = new Vbr_ram_addr_decoder_harness;
