...
//
// The C++ twin of br_ecc_sed_encoder_tb.prp: same cycle count, same reset schedule, same
...
#include "Vbr_ecc_sed_encoder_harness.h"
#include "verilated.h"
...
int main(int argc, char **argv) {
  ...
  auto *top = new Vbr_ecc_sed_encoder_harness;
