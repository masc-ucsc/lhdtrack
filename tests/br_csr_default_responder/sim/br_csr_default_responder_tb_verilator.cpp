...
//
// The C++ twin of br_csr_default_responder_tb.prp: same cycle count, same reset schedule, same
...
#include "Vbr_csr_default_responder_harness.h"
#include "verilated.h"
...
int main(int argc, char **argv) {
  ...
  auto *top = new Vbr_csr_default_responder_harness;
