...
//
// The C++ twin of br_ram_flops_tile_tb.prp: same cycle count, same reset schedule, same
...
#include "Vbr_ram_flops_tile_harness.h"
#include "verilated.h"
...
int main(int argc, char **argv) {
  ...
  auto *top = new Vbr_ram_flops_tile_harness;
