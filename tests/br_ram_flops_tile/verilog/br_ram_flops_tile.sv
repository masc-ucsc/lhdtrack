...
module br_ram_flops_tile #(
    localparam int Depth = 16,  // Must be at least 1
    localparam int Width = 32,  // Must be at least 1
    localparam int NumWritePorts = 1,  // Must be at least 1
    localparam int NumReadPorts = 1,  // Must be at least 1
    ...
    localparam int WordWidth = Width,
