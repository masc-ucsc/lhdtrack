...
//
// The C++ twin of br_fifo_ctrl_1r1w_tb.prp: same cycle count, same reset schedule, same
...
#include "Vbr_fifo_ctrl_1r1w_harness.h"
#include "verilated.h"
...
int main(int argc, char **argv) {
  ...
  auto *top = new Vbr_fifo_ctrl_1r1w_harness;
