...
//
// The C++ twin of br_multi_xfer_reg_fwd_tb.prp: same cycle count, same reset schedule, same
...
#include "Vbr_multi_xfer_reg_fwd_harness.h"
#include "verilated.h"
...
int main(int argc, char **argv) {
  ...
  auto *top = new Vbr_multi_xfer_reg_fwd_harness;
