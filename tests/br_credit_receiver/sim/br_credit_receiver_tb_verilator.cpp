...
//
// The C++ twin of br_credit_receiver_tb.prp: same cycle count, same reset schedule, same
...
#include "Vbr_credit_receiver_harness.h"
#include "verilated.h"
...
int main(int argc, char **argv) {
  ...
  auto *top = new Vbr_credit_receiver_harness;
