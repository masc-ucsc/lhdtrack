...
//
// The C++ twin of br_amba_axi_shrinker_tb.prp: same cycle count, same reset schedule, same
...
#include "Vbr_amba_axi_shrinker_harness.h"
#include "verilated.h"
...
int main(int argc, char **argv) {
  ...
  auto *top = new Vbr_amba_axi_shrinker_harness;
