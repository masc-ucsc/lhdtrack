...
//
// The C++ twin of br_apb_demux_select_onehot_tb.prp: same cycle count, same reset schedule, same
...
#include "Vbr_apb_demux_select_onehot_harness.h"
#include "verilated.h"
...
int main(int argc, char **argv) {
  ...
  auto *top = new Vbr_apb_demux_select_onehot_harness;
