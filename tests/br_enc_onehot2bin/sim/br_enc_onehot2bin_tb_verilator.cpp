...
//
// The C++ twin of br_enc_onehot2bin_tb.prp: same cycle count, same reset schedule, same
...
#include "Vbr_enc_onehot2bin_harness.h"
#include "verilated.h"
...
int main(int argc, char **argv) {
  ...
  auto *top = new Vbr_enc_onehot2bin_harness;
