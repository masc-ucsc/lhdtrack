...
//
// The C++ twin of br_mux_bin_array_tb.prp: same cycle count, same reset schedule, same
...
#include "Vbr_mux_bin_array_harness.h"
#include "verilated.h"
...
int main(int argc, char **argv) {
  ...
  auto *top = new Vbr_mux_bin_array_harness;
