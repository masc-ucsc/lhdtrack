...
//
// The C++ twin of br_mux_bin_structured_gates_tb.prp: same cycle count, same reset schedule, same
...
#include "Vbr_mux_bin_structured_gates_harness.h"
#include "verilated.h"
...
int main(int argc, char **argv) {
  ...
  auto *top = new Vbr_mux_bin_structured_gates_harness;
