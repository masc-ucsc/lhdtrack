...
//
// The C++ twin of br_demux_addr_decode_tb.prp: same cycle count, same reset schedule, same
...
#include "Vbr_demux_addr_decode_harness.h"
#include "verilated.h"
...
int main(int argc, char **argv) {
  ...
  auto *top = new Vbr_demux_addr_decode_harness;
