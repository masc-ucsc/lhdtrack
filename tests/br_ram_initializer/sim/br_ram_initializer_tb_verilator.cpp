...
//
// The C++ twin of br_ram_initializer_tb.prp: same cycle count, same reset schedule, same
...
#include "Vbr_ram_initializer_harness.h"
#include "verilated.h"
...
int main(int argc, char **argv) {
  ...
  auto *top = new Vbr_ram_initializer_harness;
