...
//
// The C++ twin of br_delay_valid_next_nr_tb.prp: same cycle count, same reset schedule, same
...
#include "Vbr_delay_valid_next_nr_harness.h"
#include "verilated.h"
...
int main(int argc, char **argv) {
  ...
  auto *top = new Vbr_delay_valid_next_nr_harness;
