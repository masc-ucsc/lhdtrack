...
//
// The C++ twin of br_ram_data_rd_pipe_tb.prp: same cycle count, same reset schedule, same
...
#include "Vbr_ram_data_rd_pipe_harness.h"
#include "verilated.h"
...
int main(int argc, char **argv) {
  ...
  auto *top = new Vbr_ram_data_rd_pipe_harness;
