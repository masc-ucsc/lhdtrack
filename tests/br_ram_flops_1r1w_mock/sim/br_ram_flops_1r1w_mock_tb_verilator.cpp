...
//
// The C++ twin of br_ram_flops_1r1w_mock_tb.prp: same cycle count, same reset schedule, same
...
#include "Vbr_ram_flops_1r1w_mock_harness.h"
#include "verilated.h"
...
int main(int argc, char **argv) {
  ...
  auto *top = new Vbr_ram_flops_1r1w_mock_harness;
