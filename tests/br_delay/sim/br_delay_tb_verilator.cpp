...
//
// The C++ twin of br_delay_tb.prp: same cycle count, same reset schedule, same
...
int main(int argc, char **argv) {
  ...
  auto *top = new Vbr_delay_harness;
