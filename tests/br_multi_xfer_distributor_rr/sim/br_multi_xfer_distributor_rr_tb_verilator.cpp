...
//
// The C++ twin of br_multi_xfer_distributor_rr_tb.prp: same cycle count, same reset schedule, same
...
#include "Vbr_multi_xfer_distributor_rr_harness.h"
#include "verilated.h"
...
int main(int argc, char **argv) {
  ...
  auto *top = new Vbr_multi_xfer_distributor_rr_harness;
