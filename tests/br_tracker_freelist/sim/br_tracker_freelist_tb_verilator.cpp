...
//
// The C++ twin of br_tracker_freelist_tb.prp: same cycle count, same reset schedule, same
...
#include "Vbr_tracker_freelist_harness.h"
#include "verilated.h"
...
int main(int argc, char **argv) {
  ...
  auto *top = new Vbr_tracker_freelist_harness;
