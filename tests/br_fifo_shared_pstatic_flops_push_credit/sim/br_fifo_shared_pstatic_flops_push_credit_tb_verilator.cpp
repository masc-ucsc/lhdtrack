...
//
// The C++ twin of br_fifo_shared_pstatic_flops_push_credit_tb.prp: same cycle count, same reset schedule, same
...
#include "Vbr_fifo_shared_pstatic_flops_push_credit_harness.h"
#include "verilated.h"
...
int main(int argc, char **argv) {
  ...
  auto *top = new Vbr_fifo_shared_pstatic_flops_push_credit_harness;
